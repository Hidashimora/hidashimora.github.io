...
В каждом файле содержится примерно **четверть конфигов** из соответствующего списка репозитория AvenCores/goida-vpn-configs. Учитываются только строки с конфигурациями протоколов **vless**, **trojan**, **vmess**, **ss**, **hy2**; из них отбирается каждая 4‑я строка. Для **обхода блокировок по SNI/CIDR** (белые списки) предназначен список **№26**. Списки №1–№25 соответствуют разным источникам и наборам серверов; описание источников приведено в [репозитории AvenCores/goida-vpn-configs](https://github.com/AvenCores/goida-vpn-configs).
